...
<template>
  <div class="space-y-32">
    ...
    <section id="work" class="space-y-16">
      <div class="flex justify-between items-baseline border-b border-[var(--color-text-charcoal)] pb-4 mb-12">
        <h2 class="text-3xl md:text-4xl font-serif">Work</h2>
      ...
      <div class="flex justify-center pt-12">
        <router-link to="/projects" class="text-lg font-serif italic border-b border-[var(--color-text-charcoal)] hover:opacity-70 transition-opacity">
          View more projects & experiments &rarr;
        </router-link>
      </div>
    </section>
  </div>
