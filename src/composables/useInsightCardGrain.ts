...
/**
 * Same grain overlay pipeline as roster grid cards (`useRosterCardPaint`):
 * flat base + hue-shifted paint-mask layer, `multiply` blend.
 */
export function useInsightCardGrain(
  ...
  return {
    grainUrl,
    paintMaskUrl: ROSTER_PAINT_MASK_URL,
    scheduleRebake,
  }
}
